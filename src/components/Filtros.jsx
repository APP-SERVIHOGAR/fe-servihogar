...
import { Box, FormGroup, FormControlLabel, Checkbox, Button, Typography } from "@mui/material";
import StarIcon from '@mui/icons-material/Star';

function Filtros({ onApply }) {
            ...
            <FormControlLabel
              ...
              control={
                <Checkbox
                  ...
                  sx={{ color: "#813ef5", '&.Mui-checked': { color: "#813ef5" } }}
                />
              }
              label={cat.nombre}
            />
      ...
      <Box>
        ...
        <FormGroup>
          {[5,4,3,2,1].map(valor => (
            <Button
              key={valor}
              variant={calificacionesSeleccionadas.includes(valor) ? "contained" : "outlined"}
              sx={{
                justifyContent: "flex-start",
                textTransform: "none",
                mb: 0.5,
                bgcolor: calificacionesSeleccionadas.includes(valor) ? "#813ef5" : "transparent",
                color: calificacionesSeleccionadas.includes(valor) ? "#fff" : "#813ef5",
                borderColor: "#813ef5",
                '&:hover': { bgcolor: "#5409DA", color: "#fff", borderColor: "#813ef5" }
              }}
